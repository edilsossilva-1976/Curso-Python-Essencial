...
"""
2.Faça um programa que peça para o usuário digitar três valores inteiro e
...
"""
3. Faça um programa que recebe três valores e apresente a soma dos quadrados
dos valores lidos.
"""
...
print(f"A soma dos quadrados de {valor1} com {valor2} e {valor3} eh {soma}")
